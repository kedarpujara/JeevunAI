// Updated EntryDetailSheet.tsx - Remove internal photo viewer and pass callback to parent
...
interface EntryDetailSheetProps {
  ...
  onPhotoPress?: (photoUri: string) => void; // Add this prop
}

const EntryDetailSheet = forwardRef<EntryDetailSheetRef, EntryDetailSheetProps>(
  ({ entry, onDismiss, onEdit, onDelete, onPhotoPress }, ref) => {
...
//                     {entry.photoUris.map((uri, index) => (
//                       <TouchableOpacity
//                         key={`photo-${index}-${uri}`} // Better key
//                         onPress={() => handlePhotoPress(uri)}
//                         activeOpacity={0.8}
//                       >
//                         <Image 
//                           source={{ uri }} 
//                           style={styles.photo}
//                           resizeMode="cover" // Add explicit resize mode
//                           onError={(error) => { // Add error handling
//                             console.log('Image failed to load:', uri, error.nativeEvent.error);
//                           }}
//                           onLoad={() => { // Add load success logging
...
//     borderRadius: theme.radius.lg,
//     marginRight: theme.spacing.sm,
//     backgroundColor: theme.colors.surface, // Add background color for loading state
//   },
//   locationContainer: {
//     flexDirection: 'row',
//     alignItems: 'center',
